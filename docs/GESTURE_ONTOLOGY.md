...
The ontology defines the semantic vocabulary between body language and scene meaning. It has three layers. Nothing here is a command; every mapping is a *weighted evidence source* consumed by the Intent Engine.
